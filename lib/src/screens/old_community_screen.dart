...
class OldCommunityScreen extends StatefulHookConsumerWidget {
  final Community community;
  final String? initialContentType;

  const OldCommunityScreen({
    super.key,
  ...
  @override
  ConsumerState<OldCommunityScreen> createState() => _OldCommunityScreenState();
}

class _OldCommunityScreenState extends ConsumerState<OldCommunityScreen> {
