...
class CommunityKeyModal extends ConsumerWidget {
  final String secretKey;
  final String profileName;

  const CommunityKeyModal({
    super.key,
            ...
            child: LabButton(
              ...
              onTap: () async {
                ...
                try {
                  ...
                  // Pop the modal and replace the entire stack up to create/community
                  context.pop(); // Pop the key modal
                  context.go('/create/community/configure', extra: {
                    'profile': profile,
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: ", that lets you fully own your Community.",
                        style: LabTheme.of(context).typography.reg16.copyWith(
                              color: LabTheme.of(context).colors.white66,
                            ),
                      ),
